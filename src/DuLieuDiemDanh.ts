...
// URL API Backend của bạn (Lấy từ thanh địa chỉ Swagger: https://localhost:7138)
// Khi deploy lên server thật, bạn nhớ đổi dòng này thành domain thật nhé (ví dụ: https://api.titkul.edu.vn/...)
const MY_API_URL =
  "https://localhost:7138/api/DiemDanh/GetSoLuongDiemDanhByNgay";
